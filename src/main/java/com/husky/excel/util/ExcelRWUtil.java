...
import com.husky.date.util.DateUtil;
import com.husky.excel.bean.DatasKeySheets;
import com.husky.excel.bean.ReadExcelI;
import com.husky.excel.bean.SheetData;
import com.husky.excel.bean.SheetDatas;
import com.husky.reflect.util.FieldUtil;
...
import com.husky.check.util.CheckUtil;
import com.husky.excel.bean.Excel;
import com.husky.excel.bean.ExcelI;
import com.husky.excel.bean.ExcelTemplate;
import com.husky.excel.bean.FormulaTemplate;
import com.husky.excel.bean.WriteExcelI;
import com.husky.io.util.FileUtil;
import com.husky.java.util.JavaUtil;
import com.husky.reflect.util.TypeUtil;
import com.husky.regex.util.RegexUtil;
...
public final class ExcelRWUtil implements Serializable {
	 ...
	 * Excel写入
	 * 
	 * @see ExcelRWUtil#writeTemplateExcel(ExcelTemplate)
	 * @param sheetDatas
	 *            所有行列数据对象
	 * @param excel
	 *            excel对象
	 ...
	 * Excel写入
	 * 
	 * @see ExcelRWUtil#writeTemplateExcel(ExcelTemplate, ExcelI)
	 * @param sheetDatas
	 *            数据集合
	 * @param excel
	 *            对象
	...
	private static Set<Sheet> getExportSheets(final ExcelTemplate excel) throws Exception {
		...
		// for (String sheetName : sheetNames) {
		// sheet = wb.getSheet(sheetName);
		// //wb.setSheetName(wb.getSheetIndex(sheet), sheetName + "--husky");
		// sheets.add(sheet);
		// }
		// } else if (sheetValue instanceof int[]) {
		// int[] sheetIndexs = (int[]) sheetValue;
