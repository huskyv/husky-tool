...
public class DesCryptUtil {
	...
	public static String encrypt(String strKey, String strIn) throws Exception {
		...
		Cipher encryptCipher = Cipher.getInstance(KEY);
	...
	public static String decrypt(String strKey, String strIn) throws Exception {
		Security.addProvider(new com.sun.crypto.provider.SunJCE());
		Key key = getKey(strKey.getBytes());
		Cipher decryptCipher = Cipher.getInstance(KEY);
	...
	private static Key getKey(byte[] arrBTmp) throws Exception {
		...
		// 生成密钥
		Key key = new javax.crypto.spec.SecretKeySpec(arrB, KEY);
		return key;
	}
	...
	public static void main(String[] args) {
		try {
			String test = "张huskyhuskyhuskyhuskyhuskyhuskyhuskyhuskyhuskyhuskyhuskyhuskyhuskyhusky军";
			String strKey = "husky2222";
			System.out.println("加密前的字符：" + test);
			test = DesCryptUtil.encrypt(strKey, test);
			System.out.println("加密后的字符：" + test);
//			test = "a69b1c9556a6f204";
			strKey = "husky2222";
			test = DesCryptUtil.decrypt(strKey, test);
			System.out.println("解密后的字符：" + test);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
